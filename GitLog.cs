	...
	class GitLog
	{
		...
		public class Commit
		{
			...
			public static Commit Parse(string line)
			{
				...
				// HACK: fixup names
				if (commit.Author == "kpatil@veinteractive.com")
					commit.Author = "kpatil";
				if (commit.Author == "Ramesh Anandakrishnan" || commit.Author == "ramesh")
					commit.Author = "rameshanandakrishnan";
